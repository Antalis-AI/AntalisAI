	...
	>
		...
		>
			<div class=" self-center mr-2">
				...
				<path
					fill-rule="evenodd"
					d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1Zm-1.5 2.5a.5.5 0 0 0-.5.5v.5H5a.5.5 0 0 0 0 1h1.5v1H5a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h.5v1a.5.5 0 0 0 1 0v-1H8a.5.5 0 0 0 0-1H6.5V8H8a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H6.5V4a.5.5 0 0 0-.5-.5ZM10 5a.5.5 0 0 1 .5.5v1.25l.75.75a.5.5 0 0 1 0 .707l-.75.75V10a.5.5 0 0 1-1 0V8.75l-.75-.75a.5.5 0 0 1 0-.707l.75-.75V5.5A.5.5 0 0 1 10 5Z"
					clip-rule="evenodd"
				/>
				</svg>
			</div>
